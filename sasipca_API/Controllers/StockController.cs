...
namespace sasipca_API.Controllers
{
    ...
    public class StockController : ControllerBase
    {
        ...
        /// <summary>
        /// Inicialização do StockController
        /// </summary>
        public StockController(SasipcaContext context, INotificationService notifService, IAuthService authService, ImageProcessingService imageProcessingService, IProductService productService)
        {
            _dbContext = context;
